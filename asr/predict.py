...
from asr.data_utils.audio import AudioSegment
...
from asr.decoders.ctc_greedy_decoder import greedy_decoder, greedy_decoder_chunk
...
class Predictor:
    def __init__(self,
        ...
        if use_pun:
            import paddle
            from asr.utils.text_utils import PunctuationExecutor
